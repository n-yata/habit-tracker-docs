...
description: 機能設計書(docs/2_basic-design/functional-design.md)を作成・更新するための詳細ガイドとテンプレート。PRDの要件を技術的にどう実現するかを設計する。機能設計書の作成・改訂時にのみ使用。
...
**重要**: `docs/2_basic-design/functional-design.md` に既存の機能設計書がある場合、
以下の優先順位に従ってください:

1. **既存の機能設計書 (`docs/2_basic-design/functional-design.md`)** - 最優先
   - プロジェクト固有の設計が記載されている
   - このスキルのガイドより優先する
